"""Phân tích 1 session: nén bản AI (fps thấp/480p/mono) -> Gemini -> bugs.json.

Dùng chung bởi qa_app.py (nút Phân tích) và server.py (POST /analyze).
...
def analyze_session(session_dir: Path) -> dict:
    """Nén (nếu chưa có) + Gemini. Ghi và trả về nội dung bugs.json."""
